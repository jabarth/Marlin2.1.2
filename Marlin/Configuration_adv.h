...
//#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.95 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.95        // (mm) Compression length applying to all extruders
  #endif
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT 24.00      // (mm^3/sec)
  #endif
#endif
