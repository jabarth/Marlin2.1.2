...
#define CUSTOM_MACHINE_NAME "CR-10S SKR E3 Turbo"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.7575
    #define DEFAULT_Ki   1.4212
    #define DEFAULT_Kd  61.8902
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 150.1613
  #define DEFAULT_bedKi 29.9424
  #define DEFAULT_bedKd 502.0393
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1201, 80.1763, 400, 96.7742 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -7, -0.700 }
...
#define X_BED_SIZE 305 // Nozzle is at X4 when homed
#define Y_BED_SIZE 305 // Nozzle is at Y2 when homed

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 4
#define Y_MIN_POS 2
#define Z_MIN_POS 0
#define X_MAX_POS 320 // 15mm Extra space on the right end
#define Y_MAX_POS 309 // 4mm Extra space behind the bed
